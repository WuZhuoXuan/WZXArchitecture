//
//  WZXCircleFriendsViewController.m
//  WZXArchitecture
//
...
#import "WZXCircleFriendsViewModel.h"

@interface WZXCircleFriendsViewController ()

@end

@implementation WZXCircleFriendsViewController
...
- (void)click{
    ...
    // 发送请求
    RACSignal *signal = [[[WZXCircleFriendsViewModel alloc]init].requestCommand execute:nil];
    [signal subscribeNext:^(id x) {
        
        NSLog(@"%@",x);
        NSString *customURL = @"WZXArchitecture://NaviPush/TwoViewController?userId=66666&age=18";
